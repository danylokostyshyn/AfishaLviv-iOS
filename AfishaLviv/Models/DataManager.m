...
{
    for (Event *item in [DataManager eventsForDate:date inManagedObjectContext:context]) {
...
{
    for (Event *item in [DataManager eventsInManagedObjectContext:context]) {
        [context deleteObject:item];
    }
}
...
{
    for (EventInfo *item in [DataManager eventsInfosInManagedObjectContext:context]) {
        [context deleteObject:item];
    }
}
...
{
    for (Place *item in [DataManager placesInManagedObjectContext:context]) {
        [context deleteObject:item];
    }
}
...
{
    for (PlaceInfo *item in [DataManager placesInfosInManagedObjectContext:context]) {
        [context deleteObject:item];
    }
}
